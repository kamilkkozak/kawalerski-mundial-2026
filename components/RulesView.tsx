...
export default function RulesView() {
  return (
    <div className="rules">
      ...
      <h3>Pula nagród</h3>
      <p>Wpisowe 100 zł. Nagrody: 1. miejsce <b>600 zł</b> (w tym +100 zł dla zwycięzcy turnieju), 2. miejsce <b>250 zł</b>, 3. miejsce <b>150 zł</b>. Kasę rozliczacie między sobą — apka tylko liczy punkty.</p>
